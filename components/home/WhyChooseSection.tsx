...
const reasons = [
  {
    ...
    description: 'We&apos;re not chasing traffic. We&apos;re building relationships that compound.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: 'From the first impression to the fifth purchase — we think in systems.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: 'Less overhead, more output. We move fast because we&apos;re built that way.',
  },
];
    ...
    <section className="why-choose">
      <div className="why-choose__header">
        ...
        <p className="why-choose__subtitle">
          Most agencies specialize in one thing. We specialize in making everything work together.
        </p>
      </div>
