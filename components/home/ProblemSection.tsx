  ...
  return (
    <section className="problem">
      ...
      <div className="problem__bg">
        <div className="problem__glow problem__glow--1" />
        <div className="problem__glow problem__glow--2" />
      ...
      <div className="problem__header">
        ...
        <h2 className="problem__title">
          Growth Isn&apos;t a <em>Channel Problem.</em> It&apos;s a{" "}
        ...
        <div className="problem__left">
          ...
          <ul className="problem__list">
            {problems.map((problem, idx) => (
              <li
                key={idx}
                className={`problem__item fade-in-up stagger-${idx + 1}`}
              >
        ...
        <div className="problem__right fade-in-up stagger-5">
          <div className="problem__solution-box">
            ...
            <p className="problem__solution-text">
              Crayon &amp; Quill builds integrated growth systems where every
              channel works together — aligned to one goal: revenue.
            </p>
          </div>
        </div>
      </div>
