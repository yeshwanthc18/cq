...
void main() {
  ...
  useEffect(() => {
    ...
    const target = hexToRgb(raysColor);
    const current = [...(u.raysColor.value as number[])];
    ...
    const animate = () => {
      ...
      u.raysColor.value = [...current];
      if (stillAnimating) frame = requestAnimationFrame(animate);
    };
